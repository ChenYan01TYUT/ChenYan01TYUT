function [Ks, t_k] = X2Ks_large_20250104(X, k, blockSize)
%
% (1) For X with ||x_i||_2 =1, all the 12 kernels, either linear or gaussian,
% will share the same neighorhood structure
% (2) The non-zero element of new kernel is only determined by the sparse
% part
% (3) The kernels are in sparse format
% (4) The block is introduced to make it suitable for large data
% 
% 
[nSmp, ~] = size(X);
